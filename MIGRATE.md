...
Write tests for new/changed functionality. Follow testing guidelines and look at existing tests first. We want only e2e/integration/api/contract tests, never unit tests for trivial functionality. Prefer table driven tests where feasible.
