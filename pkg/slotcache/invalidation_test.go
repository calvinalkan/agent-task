...
// Header offsets are in test_helpers_test.go.
// Aliases for header_state_test.go specific naming:.
const (
	hdrStateOff             = offState
	hdrUserFlagsOff         = offUserFlags
	hdrUserDataOff          = offUserData
	hdrReservedTailStartOff = offReservedTail
)
...
// =============================================================================
// Helper functions are in test_helpers_test.go
// =============================================================================
